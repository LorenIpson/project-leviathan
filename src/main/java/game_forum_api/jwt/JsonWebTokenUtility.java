...
public class JsonWebTokenUtility {
	...
	private long expire;
	private String issuer = "leviathan";
	...
	public String createToken(String data) {
		...
		try {
			...
			// 準備 JWT 主體
			JWTClaimsSet claimsSet = new JWTClaimsSet.Builder().issuer(issuer).issueTime(Date.from(now))
					.expirationTime(Date.from(expire)).subject(data).build();
